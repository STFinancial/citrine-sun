...
public class MoveOrderResponse extends MarketResponse {
    ...
    public MoveOrderResponse(String orderNumber, Map<CurrencyPair, List<CompletedTrade>> completedTrades, JsonNode jsonResponse, MarketRequest request, long timestamp, RequestStatus error) {
